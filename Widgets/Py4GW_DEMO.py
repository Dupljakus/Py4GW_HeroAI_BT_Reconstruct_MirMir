        ...
        if PyImGui.begin(f"Player"):
            ...
            if PyImGui.collapsing_header("Titles"):
                ...
                if title_data is not None:
                    ...
                    props = None
                    current_points = None
                    current_title_tier_index = None
                    points_needed_current_rank = None
                    next_title_tier_index = None
                    points_needed_next_rank = None
                    max_title_rank = None
                    max_title_tier_index = None
                    is_percentage_based = None
                    has_tiers = None
